...
public class ExcelImporterMaker : EditorWindow {
    ...
    void ExportEntity() {
        string templateFilePath = (sepalateSheet) ? "Assets/02_ThridParty/MasterData/Terasurware/Editor/EntityTemplate2.txt" : "Assets/02_ThridParty/MasterData/Terasurware/Editor/EntityTemplate.txt";
        ...
        Directory.CreateDirectory("Assets/00_OKGames/MasterData/Scripts/");
        File.WriteAllText("Assets/00_OKGames/MasterData/Scripts/" + className + ".cs", entittyTemplate);
    }

    void ExportImporter() {
        string templateFilePath = (sepalateSheet) ? "Assets/02_ThridParty/MasterData/Terasurware/Editor/ExportTemplate2.txt" : "Assets/02_ThridParty/MasterData/Terasurware/Editor/ExportTemplate.txt";
        ...
        importerTemplate = importerTemplate.Replace("$EXPORT_PATH$", Path.ChangeExtension($"Assets/Addressable/Asset/Masterdata/{fileName}", ".asset"));
        ...
        Directory.CreateDirectory("Assets/02_ThridParty/MasterData/Terasurware/Classes/Editor/");
        File.WriteAllText("Assets/02_ThridParty/MasterData/Terasurware/Classes/Editor/" + fileName + "_importer.cs", importerTemplate);
    }
